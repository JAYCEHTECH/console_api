            ...
            if serializer.is_valid():
                ...
                if bundle_amount > user_bundle_left:
                    ...
                    if response.status_code == 200:
                        ...
                        user_profile.save()
                        # ver_response = requests.get(url=f"https://api-4dbxv.ondigitalocean.app/api/v1/transaction_detail/{batch_id}/")
...
class TransactionDetail(APIView):
    ...
    # }
    # response = requests.post("https://api-4dbxv.ondigitalocean.app/validate-api-keys/", headers=headers)
    # data = response.json()
    # print(response)
